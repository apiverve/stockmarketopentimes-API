...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/stockmarketopentimes',
        'Source': 'https://github.com/apiverve/stockmarketopentimes-api',
        'Bug Tracker': 'https://github.com/apiverve/stockmarketopentimes-api/issues'
    },
    classifiers=[
