...
API_URL = 'https://api.apiverve.com/v1/stockmarketopentimes'

def call_stockmarketopentimes_api():
    """
...
if __name__ == '__main__':
    print('📤 Calling Stock Market Open Times API...\n')

    result = call_stockmarketopentimes_api()
